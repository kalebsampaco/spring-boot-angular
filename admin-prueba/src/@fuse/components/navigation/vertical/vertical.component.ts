...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input() navigationFooter: FuseNavigationItem[];
    ...
    @Output() readonly openAsidedense: EventEmitter<any> = new EventEmitter<any>();
    ...
    private _onMouseenter(): void
    {
        ...
        this.openAsidedense.emit({'asideDenseOpen': true})
        // Set the hovered
        this._hovered = true;
    }
    ...
    private _onMouseleave(): void
    {
        // Enable the animations
        this._enableAnimations();
        this.openAsidedense.emit({'asideDenseOpen': false})
        // Set the hovered
        this._hovered = false;
    }
